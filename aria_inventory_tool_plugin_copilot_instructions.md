...
python CommandRecord = { "cmd\_id": str, "device\_id": str, "type": "info" | "action", "subType": str, "capability": str,          # canonical, language-agnostic "unit": str | None, "range": tuple | None, "tags": set[str],           # mandatory command-level tags }
...
### 10.1 Stable tools (defined elsewhere)

Inventory plugin NEVER defines tools.
...
- MQTT / source callbacks push into queue
...
Inventory becomes just one producer of structured capabilities, enabling:
